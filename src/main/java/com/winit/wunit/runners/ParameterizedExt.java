package com.winit.wunit.runners;
 ...
 * 		return Arrays
 * 				.asList(new Object[][] { { 0, 0 }, { 1, 1 }, { 2, 1 }, { 3, 2 }, { 4, 3 }, { 5, 5 }, { 6, 8 } });
 * 	}
 *
 * 	private int fInput;
 *
 ...
 * @since 4.0
 */
public class ParameterizedExt extends SpringJUnit4ClassRunner {

	public ParameterizedExt(Class<?> clazz) throws Throwable {
		super(clazz);
		// TODO Auto-generated constructor stub
		ParametersRunnerFactory runnerFactory = getParametersRunnerFactory(clazz);
		Parameters parameters = getParametersMethod().getAnnotation(Parameters.class);
		runners = Collections
				.unmodifiableList(createRunnersForParameters(allParameters(), parameters.name(), runnerFactory));
	...
	private Iterable<Object> allParameters() throws Throwable {
		Object parameters = Arrays.asList(new Object[][] { { -1, 1, 0 }, { 20, 20, 40 }, { 30, 30, 60 }, { -5, -5, -10 } });
