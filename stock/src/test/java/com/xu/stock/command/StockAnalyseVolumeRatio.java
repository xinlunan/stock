...
import com.xu.stock.analyse.controller.VolumeRatioAnalyseController;
...
public class StockAnalyseVolumeRatio extends BaseTestCase {

    public static final int              NUM_THREADS = 1;
    @Resource
    private StockDailyController             stockDailyController;
    @Resource
    private VolumeRatioAnalyseController volumeRatioAnalyseController;

    @Test
    public void highestProbeBuyAnalyse() {
        log.info("最高点试探分析购买开始...");
        volumeRatioAnalyseController.analyse(NUM_THREADS);
