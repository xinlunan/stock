...
public class HighestProbeValue implements Serializable {
	...
	/** 样本初始价 */
	private Integer p1_FirstPrice;
	/** 上次最低价 */
	private Integer p2_LastLowest;
	/** 上次最高价 */
	private Integer p3_LastHighest;
	/** 这次最低价 */
	private Integer p4_ThisLowest;
	/** 当前价 */
	private Integer p5_CurrentPrice;
	/** 预期临界最低价 */
	private Integer p6_ExpectCriticalLow;
	/** 预期临界最高价 */
	private Integer p7_ExpectCriticalHigh;
	/** 上次波动周期 */
	...
	public Integer getP1_FirstPrice() {
		return p1_FirstPrice;
	}

	public void setP1_FirstPrice(Integer p1_FirstPrice) {
		this.p1_FirstPrice = p1_FirstPrice;
	}

	public Integer getP2_LastLowest() {
		return p2_LastLowest;
	}

	public void setP2_LastLowest(Integer p2_LastLowest) {
		this.p2_LastLowest = p2_LastLowest;
	}

	public Integer getP3_LastHighest() {
		return p3_LastHighest;
	}

	public void setP3_LastHighest(Integer p3_LastHighest) {
		this.p3_LastHighest = p3_LastHighest;
	}

	public Integer getP4_ThisLowest() {
		return p4_ThisLowest;
	}

	public void setP4_ThisLowest(Integer p4_ThisLowest) {
		this.p4_ThisLowest = p4_ThisLowest;
	}

	public Integer getP5_CurrentPrice() {
		return p5_CurrentPrice;
	}

	public void setP5_CurrentPrice(Integer p5_CurrentPrice) {
		this.p5_CurrentPrice = p5_CurrentPrice;
	}

	public Integer getP6_ExpectCriticalLow() {
		return p6_ExpectCriticalLow;
	}

	public void setP6_ExpectCriticalLow(Integer p6_ExpectCriticalLow) {
		this.p6_ExpectCriticalLow = p6_ExpectCriticalLow;
	}

	public Integer getP7_ExpectCriticalHigh() {
		return p7_ExpectCriticalHigh;
	}

	public void setP7_ExpectCriticalHigh(Integer p7_ExpectCriticalHigh) {
